...
---
--- Supported trees:
---   neo-tree  → pdfport.integrations.neotree
---   nvim-tree → pdfport.integrations.nvim_tree
---   netrw     → pdfport.integrations.netrw
---   oil.nvim  → pdfport.integrations.oil
